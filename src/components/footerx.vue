        ...
        <div class="cart">
          <div class="btn-group dropup">
            ...
            <div class="dropdown-menu dropdown-menu-right" id="123">
              ...
              <router-link to="/shoppingCart" class="cartA" v-if="cartNum">查看購物車</router-link>
              <router-link to="/customerOrders" class="cartA" v-if="!cartNum">立即去購物</router-link>
              <!-- Dropdown menu links -->
            </div>
          </div>
        </div>
